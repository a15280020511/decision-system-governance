...
class ReasoningFlagshipPriceSelectionTests(unittest.TestCase):
    def test_company_strongest_reasoning_model_wins_before_price_sort(self) -> None:
        rows = [
            model("openai/gpt-5.6-sol-pro", 1.0, 4.0),
